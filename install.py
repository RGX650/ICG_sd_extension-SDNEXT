...
if not launch.is_installed("transformers>=4.36.2"):
    if not launch.is_installed("accelerate>=0.25.0"):
        launch.run_pip("install accelerate==0.28.0", "requirements for Image Caption")
    launch.run_pip("install transformers==4.38.2", "requirements for Image Caption")
